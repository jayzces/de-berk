...
<template>
  <div class="container">
    ...
    <div
      class="columns-4 gap-6 mt-8 relative after:content-[''] after:block after:absolute after:left-0 after:bottom-0 after:right-0 after:h-2/5 after:bg-gradient-to-b after:from-transparent after:to-cream after:pointer-events-none"
    >
      <div
